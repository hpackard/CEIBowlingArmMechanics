...
[ramper, cfg] = cfgDoA_from_TimeData(radarRxs);
...
cfgRadarData.ramps = cfg.rmpCfg.NoRamps*2;
...
for idx=1:1:2000
    ...
    ememData = accessMemory.readMem('0xB9000000', cfgRadarData.samples*2 * cfgRadarData.ramps*NoRX*4*2);
    ememData = bitshift(ememData, -(32-cfgRadarData.bitWidth));
    ememData = twoComp(ememData(1:2:end-1), cfgRadarData.bitWidth);
    ememData = reshape(ememData, cfgRadarData.samples, NoRX, cfgRadarData.ramps * 2);
